...
import { deleteBeak, getComb, updateBeak, addComb} from "../../actions/crud/eyesAttributes";
...
class EyesContainer extends Component {
  ...
  handleOk = () => {
    ...
    else if(this.state.modalTitle==="Add New Eyes"){
...
function mapStateToProps(state) {
  ...
  return {
    eyes: state.attribute.eyes,
    isDeleted: state.attribute.beakDeleteStatus,
    isUpdated: state.attribute.eyesUpdateStatus,
    isNewAdded: state.attribute.newEyesAdded,
    alertMsg: state.attribute.alertMsg,  
    isError: state.attribute.isError    
  };
}
export default connect(mapStateToProps)(EyesContainer);
