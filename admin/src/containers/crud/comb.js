...
import { deleteBeak, getComb, updateBeak, addComb} from "../../actions/crud/combAttributes";
import Modal from "antd/lib/modal/Modal";
//import Alert from "../../components/alert/alert";

class CombContainer extends Component {
  constructor(props) {
    super(props);
  ...
  handleOk = () => {
    ...
    else if(this.state.modalTitle==="Add New Comb"){
